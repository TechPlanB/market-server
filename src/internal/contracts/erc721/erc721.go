...
// IsAdminOfMintBurn is a free data retrieval call binding the contract method 0x9d4ee684.
//
// Solidity: function isAdminOfMintBurn(address _account) view returns(bool)
func (_Erc721 *Erc721Caller) IsAdminOfMintBurn(opts *bind.CallOpts, _account common.Address) (bool, error) {
	var out []interface{}
	err := _Erc721.contract.Call(opts, &out, "isAdminOfMintBurn", _account)
...
//
// Solidity: function isAdminOfMintBurn(address _account) view returns(bool)
func (_Erc721 *Erc721Session) IsAdminOfMintBurn(_account common.Address) (bool, error) {
	return _Erc721.Contract.IsAdminOfMintBurn(&_Erc721.CallOpts, _account)
}

// IsAdminOfMintBurn is a free data retrieval call binding the contract method 0x9d4ee684.
//
// Solidity: function isAdminOfMintBurn(address _account) view returns(bool)
func (_Erc721 *Erc721CallerSession) IsAdminOfMintBurn(_account common.Address) (bool, error) {
	return _Erc721.Contract.IsAdminOfMintBurn(&_Erc721.CallOpts, _account)
}
...
// AddAdminOfMintBurn is a paid mutator transaction binding the contract method 0xd0cc2a4b.
//
// Solidity: function addAdminOfMintBurn(address _account) returns()
func (_Erc721 *Erc721Transactor) AddAdminOfMintBurn(opts *bind.TransactOpts, _account common.Address) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "addAdminOfMintBurn", _account)
}

// AddAdminOfMintBurn is a paid mutator transaction binding the contract method 0xd0cc2a4b.
//
// Solidity: function addAdminOfMintBurn(address _account) returns()
func (_Erc721 *Erc721Session) AddAdminOfMintBurn(_account common.Address) (*types.Transaction, error) {
	return _Erc721.Contract.AddAdminOfMintBurn(&_Erc721.TransactOpts, _account)
}

// AddAdminOfMintBurn is a paid mutator transaction binding the contract method 0xd0cc2a4b.
//
// Solidity: function addAdminOfMintBurn(address _account) returns()
func (_Erc721 *Erc721TransactorSession) AddAdminOfMintBurn(_account common.Address) (*types.Transaction, error) {
	return _Erc721.Contract.AddAdminOfMintBurn(&_Erc721.TransactOpts, _account)
}
...
// RemoveAdminOfMintBurn is a paid mutator transaction binding the contract method 0xc9f88a86.
//
// Solidity: function removeAdminOfMintBurn(address _account) returns()
func (_Erc721 *Erc721Transactor) RemoveAdminOfMintBurn(opts *bind.TransactOpts, _account common.Address) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "removeAdminOfMintBurn", _account)
}

// RemoveAdminOfMintBurn is a paid mutator transaction binding the contract method 0xc9f88a86.
//
// Solidity: function removeAdminOfMintBurn(address _account) returns()
func (_Erc721 *Erc721Session) RemoveAdminOfMintBurn(_account common.Address) (*types.Transaction, error) {
	return _Erc721.Contract.RemoveAdminOfMintBurn(&_Erc721.TransactOpts, _account)
}

// RemoveAdminOfMintBurn is a paid mutator transaction binding the contract method 0xc9f88a86.
//
// Solidity: function removeAdminOfMintBurn(address _account) returns()
func (_Erc721 *Erc721TransactorSession) RemoveAdminOfMintBurn(_account common.Address) (*types.Transaction, error) {
	return _Erc721.Contract.RemoveAdminOfMintBurn(&_Erc721.TransactOpts, _account)
}
...
// Erc721MintBurnAdminChangedIterator is returned from FilterMintBurnAdminChanged and is used to iterate over the raw logs and unpacked data for MintBurnAdminChanged events raised by the Erc721 contract.
type Erc721MintBurnAdminChangedIterator struct {
	Event *Erc721MintBurnAdminChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Erc721MintBurnAdminChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Erc721MintBurnAdminChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Erc721MintBurnAdminChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Erc721MintBurnAdminChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Erc721MintBurnAdminChanged represents a MintBurnAdminChanged event raised by the Erc721 contract.
type Erc721MintBurnAdminChanged struct {
	Account common.Address
	Result  bool
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterMintBurnAdminChanged is a free log retrieval operation binding the contract event 0xda25bc411ec3d373ab25a04515e70b6be56e13cb1cb490337c6a52db349a8e07.
//
// Solidity: event MintBurnAdminChanged(address indexed _account, bool _result)
func (_Erc721 *Erc721Filterer) FilterMintBurnAdminChanged(opts *bind.FilterOpts, _account []common.Address) (*Erc721MintBurnAdminChangedIterator, error) {
	...
	logs, sub, err := _Erc721.contract.FilterLogs(opts, "MintBurnAdminChanged", _accountRule)
	if err != nil {
		return nil, err
	}
	return &Erc721MintBurnAdminChangedIterator{contract: _Erc721.contract, event: "MintBurnAdminChanged", logs: logs, sub: sub}, nil
}

// WatchMintBurnAdminChanged is a free log subscription operation binding the contract event 0xda25bc411ec3d373ab25a04515e70b6be56e13cb1cb490337c6a52db349a8e07.
//
// Solidity: event MintBurnAdminChanged(address indexed _account, bool _result)
func (_Erc721 *Erc721Filterer) WatchMintBurnAdminChanged(opts *bind.WatchOpts, sink chan<- *Erc721MintBurnAdminChanged, _account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Erc721.contract.WatchLogs(opts, "MintBurnAdminChanged", _accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc721MintBurnAdminChanged)
				if err := _Erc721.contract.UnpackLog(event, "MintBurnAdminChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseMintBurnAdminChanged is a log parse operation binding the contract event 0xda25bc411ec3d373ab25a04515e70b6be56e13cb1cb490337c6a52db349a8e07.
//
// Solidity: event MintBurnAdminChanged(address indexed _account, bool _result)
func (_Erc721 *Erc721Filterer) ParseMintBurnAdminChanged(log types.Log) (*Erc721MintBurnAdminChanged, error) {
	event := new(Erc721MintBurnAdminChanged)
	if err := _Erc721.contract.UnpackLog(event, "MintBurnAdminChanged", log); err != nil {
		return nil, err
	}
